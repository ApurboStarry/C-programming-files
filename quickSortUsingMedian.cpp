...
int main()
{
    ...
    if(n%2 == 0){
        cout << "Median is : " << arr[(n-1)/2] << " or " << arr[((n-1)/2) +1] << endl;
        //cout << "Median is : " << kthSmallest(arr,0,n,n/2) << " or " << kthSmallest(arr,0,n,(n/2) + 1) << endl;
    }else {
        cout << "Median is : " << arr[(n-1)/2] << endl;
        //cout << "Median is : " << kthSmallest(arr,0,n,n/2) << endl;
    }

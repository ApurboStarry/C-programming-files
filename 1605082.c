    ...
    while(input!=11)
    {
        ...
        switch(input)
        {
            ...
            case 7: printf("\t\t\tDemonstration of 'strchr' function\n");
                    ...
                    scanf("%s",&ch);
                    //p=strchr(str1,ch);
                    printf("The result is: %s",strchr(str1,ch));
                    //printf(p);
                    getche();
                    system("cls");
                    break;
            ...
            case 8: printf("\t\t\tDemonstration of 'strstr' function\n");
                    ...
                    scanf(" %[^\n]", str2);
                    printf("The result is: %s",strstr(str1,str2));
                    getche();
                    system("cls");
                    break;

            case 9: printf("\t\t\tDemonstration of strrstr function\n");
                    printf("Enter your first string: ");
                    scanf(" %[^\n]", str1);
                    printf("Enter your second string: ");
                    scanf(" %[^\n]", str2);
                    printf("The result is : %s",strrstr(str1,str2));
                    getche();
                    system("cls");
                    break;

            case 10: printf("Enter the string that is to be reversed: ");
                     scanf(" %[^\n]", str1);
                     strrev(str1);
